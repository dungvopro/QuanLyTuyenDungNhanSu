<%@ Page Title="" Language="C#" MasterPageFile="~/QuanLy.Master" AutoEventWireup="true" CodeBehind="CaDon1.aspx.cs" Inherits="TeamHire.CaDon1" %>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Ca đơn</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label1" runat="server" Text="Giờ làm việc" ForeColor="#333333"></asp:Label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label10" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="dropdown-divider"></div>
                                    <asp:Label ID="Label4" runat="server" Text="Giờ Check in hợp lệ" ForeColor="#333333"></asp:Label>
                                </div>
                                <div class="form-group">
                                    <div class="form-inline">
                                    ...
                                    <asp:Label ID="Label11" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="dropdown-divider"></div>
                                    <asp:Label ID="Label7" runat="server" Text="Giờ Check out hợp lệ" ForeColor="#333333"></asp:Label>
                                </div>
                                <div class="form-group">
                                    <div class="form-inline">
                                    ...
                                    <asp:Label ID="Label12" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                                </div>
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-secondary" runat="server" id="myCard">
                                    ...
                                    <div class="card-body">
                                        <div class="form-inline">
                                            <asp:Label ID="Label19" runat="server" CssClass="mr-2" Text="Thời gian tính đi muộn:"></asp:Label>
                                        ...
                                        <asp:Label ID="Label13" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                                        <br />
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <asp:Label ID="Label15" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                            ...
                            <div class="col-md-6">
                                <div class="card card-secondary" runat="server" id="toiCard">
                                    ...
                                    <div class="card-body">
                                        <div class="form-inline">
                                            <asp:Label ID="Label23" runat="server" CssClass="mr-2" Text="Thời gian tính về sớm:"></asp:Label>
                                            ...
                                            <asp:Label ID="Label14" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                                        </div>
                                        <br />
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <asp:Label ID="Label16" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                        ...
                        <asp:Label ID="Label17" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                        <br />
                        ...
                        <asp:Label ID="Label18" runat="server" Text="thời gian*" Visible="False" ForeColor="Red"></asp:Label>
                    </div>
                    <!-- /.card-body -->
