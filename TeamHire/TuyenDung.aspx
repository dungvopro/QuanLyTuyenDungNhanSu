<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TuyenDung.aspx.cs" Inherits="TeamHire.TuyenDung" %>
...
<body>
    ...
    <form id="form1" runat="server">
                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-8">
                        <div class="left-content">
                            <p>Nhóm phát triển dự án<em>K26 TPM6</em> khoa CNTT </p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-4">
                        <div class="right-icons">
                            <ul>
                                ...
                                <li><a href="#"><i class="fa fa-user-plus"></i><span> Đăng ký</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <nav class="main-nav">
                            <!-- ***** Logo Start ***** -->
                            <a href="index.aspx" class="logo">TEAMHIRE
                            </a>
                            <!-- ***** Logo End ***** -->
                            <!-- ***** Menu Start ***** -->
                            <ul class="nav">
                                <li><a href="Index.aspx">Trang Chủ</a></li>
                                <li><a href="TuyenDung.aspx" class="active">Tuyển dụng</a></li>
                                ...
                                <li class="scroll-to-section"><a href="#">Quản Trị</a></li>
                                <li class="scroll-to-section"><a href="#">Tài Khoản</a></li>
                            </ul>
        ...
        <section class="meetings-page" id="meetings">
          ...
          <br>
                    Design: <a href="https://templatemo.com/page/1" target="_parent" title="website templates">TemplateMo</a>
                </p>
            </div>
        </section>
