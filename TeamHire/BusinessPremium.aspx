<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessPremium.aspx.cs" Inherits="TeamHire.BusinessPremium" %>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6 d-flex align-items-stretch">
                        <div class="info-box">
                            ...
                            <h3>Họ tên đầy đủ:</h3>
                            <p>
                                <asp:TextBox ID="TextBox1" runat="server" class="form-control">Thỏ Chê Cỏ</asp:TextBox>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mt-4 mt-md-0 d-flex align-items-stretch">
                        <div class="info-box">
                            ...
                            <p>
                                <asp:DropDownList class="dungvip form-control" runat="server" ID="goivopro" AutoPostBack="True" OnSelectedIndexChanged="cachtuan_SelectedIndexChanged">
                                    <asp:ListItem Value="0">Gói 1 tháng</asp:ListItem>
                                    <asp:ListItem Value="1">Gói 6 tháng</asp:ListItem>
                                </asp:DropDownList>
                            </p>
